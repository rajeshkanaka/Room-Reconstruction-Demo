...
def get_args_parser():
    ...
    parser.add_argument('--backbone', default='swinv2_L_192_22k', type=str,
                        help="Name of the convolutional backbone to use")#swinv2_L_192_22k  swin_L_384_22k
    ...
    parser.add_argument('--checkpoint', default='checkpoint/scenecad.pth', help='resume from checkpoint')
