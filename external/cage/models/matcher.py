    ...
    def forward(self, outputs, targets):
        ...
        Params:
            outputs: This is a dict that contains at least these entries:
                 ...
                 "pred_coords": Tensor of dim [batch_size, num_polys, num_queries_per_poly, 4] with the predicted polygons coordinates
            ...
            targets: This is a list of targets (len(targets) = batch_size), where each target is a dict containing:
                 ...
                 "coords": Tensor of dim [num_target_polys, num_queries_per_poly * 4] containing the target polygons coordinates
