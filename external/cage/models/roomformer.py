...
# ------------------------------------------------------------------------------------
# Modified from RoomFormer (https://github.com/ywyue/RoomFormer)
#-------------------------------------------------------------------------------------
...
class RoomFormer(nn.Module):
    ...
    def __init__(self, backbone, transformer, num_classes, num_queries, num_polys, num_feature_levels,
        ...
        self.label_enc = nn.Embedding(num_classes + 1, hidden_dim - 1)  # 1 for indicator
    ...
    def forward(self, samples: NestedTensor,dn_args=None):
        """ The forward expects a NestedTensor, which consists of:
            ...
            It returns a dict with the following elements:
               ...
               - "pred_coords": The normalized edge coordinates for all queries, represented as
                               (x1, y1, x2, y2). These values are normalized in [0, 1],
