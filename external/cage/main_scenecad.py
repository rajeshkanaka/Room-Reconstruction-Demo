...
def get_args_parser():
    ...
    parser.add_argument('--lr_drop', default=[320], type=list)
    ...
    parser.add_argument('--job_name', default='edge_dn_swinv2ceweight1_coord6_raster1', type=str)
    ...
    parser.add_argument('--label_noise_scale', default=0.4, type=float,
                        help="label noise ratio to flip")
    parser.add_argument('--poly_noise_scale', default=0.5, type=float,
